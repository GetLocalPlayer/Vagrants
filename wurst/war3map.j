...
trigger gg_trg_Cursed_Talisman_to_Pendant_of_Energy= null
trigger gg_trg_Cursed_Armor__to_Defender_Spaulders= null
trigger gg_trg_Cursed_Bow__to_Hunting_Bow= null
...
// Trigger: Start Map
//===========================================================================
function Trig_Start_Map_Func021Func001C takes nothing returns boolean
...
function Trig_Start_Map_Func021A takes nothing returns nothing
    if ( Trig_Start_Map_Func021Func001C() ) then
...
function Trig_Start_Map_Actions takes nothing returns nothing
    ...
    call ForForce(GetPlayersAll(), function Trig_Start_Map_Func021A)
endfunction
...
//===========================================================================
// Trigger: Cursed Talisman to Pendant of Energy
//===========================================================================
function Trig_Cursed_Talisman_to_Pendant_of_Energy_Conditions takes nothing returns boolean
...
function Trig_Cursed_Talisman_to_Pendant_of_Energy_Func002C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I02E' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Talisman_to_Pendant_of_Energy_Func003C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I00U' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Talisman_to_Pendant_of_Energy_Actions takes nothing returns nothing
    if ( Trig_Cursed_Talisman_to_Pendant_of_Energy_Func002C() ) then
    ...
    if ( Trig_Cursed_Talisman_to_Pendant_of_Energy_Func003C() ) then
        call SetItemVisibleBJ(false, GetSpellTargetItem())
        call CreateItemLoc('I00I', GetItemLoc(GetSpellTargetItem()))
        call SetItemPlayerBJ(GetLastCreatedItem(), GetOwningPlayer(GetTriggerUnit()), true)
        call RemoveItem(GetSpellTargetItem())
        call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), 'I00D'))
        call AddSpecialEffectLocBJ(GetItemLoc(GetLastCreatedItem()), "Abilities\\Spells\\Items\\AIem\\AIemTarget.mdl")
        call DestroyEffectBJ(GetLastCreatedEffectBJ())
    else
    endif
endfunction
...
//===========================================================================
function InitTrig_Cursed_Talisman_to_Pendant_of_Energy takes nothing returns nothing
    set gg_trg_Cursed_Talisman_to_Pendant_of_Energy=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Cursed_Talisman_to_Pendant_of_Energy, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddCondition(gg_trg_Cursed_Talisman_to_Pendant_of_Energy, Condition(function Trig_Cursed_Talisman_to_Pendant_of_Energy_Conditions))
    call TriggerAddAction(gg_trg_Cursed_Talisman_to_Pendant_of_Energy, function Trig_Cursed_Talisman_to_Pendant_of_Energy_Actions)
endfunction

//===========================================================================
// Trigger: Cursed Armor  to Defender Spaulders
//===========================================================================
function Trig_Cursed_Armor__to_Defender_Spaulders_Conditions takes nothing returns boolean
    if ( not ( GetSpellAbilityId() == 'A031' ) ) then
        return false
    endif
    return true
...
function Trig_Cursed_Armor__to_Defender_Spaulders_Func002C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I02D' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Armor__to_Defender_Spaulders_Func003C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I00S' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Armor__to_Defender_Spaulders_Actions takes nothing returns nothing
    if ( Trig_Cursed_Armor__to_Defender_Spaulders_Func002C() ) then
        call RemoveItem(GetSpellTargetItem())
        call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), 'I00D'))
    ...
    if ( Trig_Cursed_Armor__to_Defender_Spaulders_Func003C() ) then
        call SetItemVisibleBJ(false, GetSpellTargetItem())
        call CreateItemLoc('I00N', GetItemLoc(GetSpellTargetItem()))
        call SetItemPlayerBJ(GetLastCreatedItem(), GetOwningPlayer(GetTriggerUnit()), true)
        call RemoveItem(GetSpellTargetItem())
        call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), 'I00D'))
        call AddSpecialEffectLocBJ(GetItemLoc(GetLastCreatedItem()), "Abilities\\Spells\\Items\\AIem\\AIemTarget.mdl")
...
//===========================================================================
function InitTrig_Cursed_Armor__to_Defender_Spaulders takes nothing returns nothing
    set gg_trg_Cursed_Armor__to_Defender_Spaulders=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Cursed_Armor__to_Defender_Spaulders, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddCondition(gg_trg_Cursed_Armor__to_Defender_Spaulders, Condition(function Trig_Cursed_Armor__to_Defender_Spaulders_Conditions))
    call TriggerAddAction(gg_trg_Cursed_Armor__to_Defender_Spaulders, function Trig_Cursed_Armor__to_Defender_Spaulders_Actions)
endfunction

//===========================================================================
// Trigger: Cursed Bow  to Hunting Bow
//===========================================================================
function Trig_Cursed_Bow__to_Hunting_Bow_Conditions takes nothing returns boolean
    if ( not ( GetSpellAbilityId() == 'A031' ) ) then
        return false
    endif
    return true
...
function Trig_Cursed_Bow__to_Hunting_Bow_Func002C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I001' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Bow__to_Hunting_Bow_Func003C takes nothing returns boolean
    if ( not ( GetItemTypeId(GetSpellTargetItem()) == 'I00T' ) ) then
        return false
    endif
    return true
endfunction

function Trig_Cursed_Bow__to_Hunting_Bow_Actions takes nothing returns nothing
    if ( Trig_Cursed_Bow__to_Hunting_Bow_Func002C() ) then
        call RemoveItem(GetSpellTargetItem())
        call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), 'I00D'))
    ...
    if ( Trig_Cursed_Bow__to_Hunting_Bow_Func003C() ) then
        call SetItemVisibleBJ(false, GetSpellTargetItem())
        call CreateItemLoc('I00P', GetItemLoc(GetSpellTargetItem()))
        call SetItemPlayerBJ(GetLastCreatedItem(), GetOwningPlayer(GetTriggerUnit()), true)
        call RemoveItem(GetSpellTargetItem())
        call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), 'I00D'))
        call AddSpecialEffectLocBJ(GetItemLoc(GetLastCreatedItem()), "Abilities\\Spells\\Items\\AIem\\AIemTarget.mdl")
...
//===========================================================================
function InitTrig_Cursed_Bow__to_Hunting_Bow takes nothing returns nothing
    set gg_trg_Cursed_Bow__to_Hunting_Bow=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Cursed_Bow__to_Hunting_Bow, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddCondition(gg_trg_Cursed_Bow__to_Hunting_Bow, Condition(function Trig_Cursed_Bow__to_Hunting_Bow_Conditions))
    call TriggerAddAction(gg_trg_Cursed_Bow__to_Hunting_Bow, function Trig_Cursed_Bow__to_Hunting_Bow_Actions)
endfunction
...
function TimerReviveLine takes nothing returns nothing
    local timer tim= GetExpiredTimer()
    local integer hid= GetHandleId(tim)
    ...
    local integer score= LoadInteger(udg_hash, hid, 0)
    local integer cal= LoadInteger(udg_hash, hid, 1)
    local integer fin_score= LoadInteger(udg_hash, hid, 2)
    local integer index= LoadInteger(udg_hash, hid, 3)
    local real new_x= (((x )*1.0) + (( 35.00 )*1.0) * Cos((( angle)*1.0) * bj_DEGTORAD)) // INLINED!!
    local real new_y= (((y )*1.0) + (( 35.00 )*1.0) * Sin((( angle)*1.0) * bj_DEGTORAD)) // INLINED!!
    local unit target= LoadUnitHandle(udg_hash, hid, 0)
    local effect eff= AddSpecialEffect("Abilities\\Spells\\Other\\Levelup\\LevelupCaster.mdl", new_x, new_y)
    call DestroyEffect(eff)
    if score + 1 == fin_score then
        call PauseTimer(tim)
        call DestroyTimer(tim)
        ...
        call RemoveSavedInteger(udg_hash, hid, 3)
        call FlushChildHashtable(udg_hash, hid)
        if udg_Heroes[index] != null then
            call ReviveHero(udg_Heroes[index], new_x, new_y, true)
            call SetUnitState(udg_Heroes[index], UNIT_STATE_LIFE, GetUnitState(udg_Heroes[index], UNIT_STATE_MAX_LIFE) * ( 0.30 + 0.10 * cal ))
            call SetUnitState(udg_Heroes[index], UNIT_STATE_MANA, GetUnitState(udg_Heroes[index], UNIT_STATE_MAX_MANA) * ( 0.30 + 0.10 * cal ))
        else
            set udg_CountPlayers=udg_CountPlayers - 1
        endif
        set hid=GetHandleId(target)
        call DestroyTextTag(LoadTextTagHandle(udg_hash, hid, 10))
        call FlushChildHashtable(udg_hash, hid)
        call KillUnit(target)
        set udg_HeroesTomb[index]=null
        if GetLocalPlayer() == Player(index) then
            call ClearSelection()
            call SelectUnit(udg_Heroes[index], true)
            call PanCameraToTimed(GetUnitX(udg_Heroes[index]), GetUnitY(udg_Heroes[index]), 0.00)
        endif
    else
        call SaveReal(udg_hash, hid, 0, new_x)
        call SaveReal(udg_hash, hid, 1, new_y)
        call SaveInteger(udg_hash, hid, 0, score + 1)
    endif
    set tim=null
    set eff=null
...
function Trig_Revive_Actions takes nothing returns nothing
    ...
    local integer cal= GetUnitAbilityLevel(caster, 'A01Q')
    local real angle= FacingAngle(x , y , xt , yt)
    local integer fin_score= R2I(DistanceBetweenCoords(x , y , xt , yt) / 35.00)
    local timer tim= CreateTimer()
    local integer hid= GetHandleId(tim)
    set udg_CountPlayers=udg_CountPlayers + 1
    ...
    call SaveInteger(udg_hash, hid, 0, 0)
    call SaveInteger(udg_hash, hid, 1, cal)
    call SaveInteger(udg_hash, hid, 2, fin_score)
    call SaveInteger(udg_hash, hid, 3, GetPlayerId(GetOwningPlayer(target)))
    call SaveUnitHandle(udg_hash, hid, 0, target)
    call TimerStart(tim, 0.05, true, function TimerReviveLine)
    set target=null
    set caster=null
    set tim=null
endfunction
...
function InitTrig_Resurrection takes nothing returns nothing
    ...
    call TriggerAddCondition(gg_trg_Resurrection, Condition(function Trig_Revive_Conditions))
    call TriggerAddAction(gg_trg_Resurrection, function Trig_Revive_Actions)
endfunction
...
//===========================================================================
// Trigger: Cleaning rod
//===========================================================================
function Trig_Cleaning_rod_Conditions takes nothing returns boolean
    if ( not ( GetSpellAbilityId() == 'A031' ) ) then
        return false
    endif
    return true
...
function Trig_Cleaning_rod_Actions takes nothing returns nothing
    call UnitRemoveBuffsBJ(bj_REMOVEBUFFS_NEGATIVE, GetSpellTargetUnit())
endfunction

//===========================================================================
function InitTrig_Cleaning_rod takes nothing returns nothing
    set gg_trg_Cleaning_rod=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Cleaning_rod, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddCondition(gg_trg_Cleaning_rod, Condition(function Trig_Cleaning_rod_Conditions))
    call TriggerAddAction(gg_trg_Cleaning_rod, function Trig_Cleaning_rod_Actions)
endfunction

//===========================================================================
// Trigger: Cleaning staff
//===========================================================================
//TESH.scrollpos=-1
//TESH.alwaysfold=0
function Trig_Cleaning_staff_Conditions takes nothing returns boolean
    return GetSpellAbilityId() == 'A02W'
endfunction

function GroupRemoveNegativeEffect takes nothing returns nothing
    local effect eff= AddSpecialEffectTarget("Abilities\\Spells\\Items\\AIda\\AIdaTarget.mdl", GetEnumUnit(), "overhead")
    call DestroyEffect(eff)
    set eff=null
    call UnitRemoveBuffs(GetEnumUnit(), false, true)
endfunction

function TimerCleaningStaff takes nothing returns nothing
    local timer tim= GetExpiredTimer()
    local integer hid= GetHandleId(tim)
    local group gr= LoadGroupHandle(udg_hash, hid, 0)
    local integer score= LoadInteger(udg_hash, hid, 0)
    call ForGroup(gr, function GroupRemoveNegativeEffect)
    if score + 1 == 100 then
        call PauseTimer(tim)
        call DestroyTimer(tim)
        call FlushChildHashtable(udg_hash, hid)
...
function Trig_Cleaning_staff_Actions takes nothing returns nothing
    local real x= GetSpellTargetX()
    local real y= GetSpellTargetY()
    local group gr= CreateGroup()
    local timer tim= CreateTimer()
    local integer hid= GetHandleId(tim)
    call GroupEnumUnitsInRange(gr, x, y, 330.00, Condition(function FilterGroupAddHero))
    call SaveGroupHandle(udg_hash, hid, 0, gr)
    call SaveInteger(udg_hash, hid, 0, 0)
    call TimerStart(tim, 0.05, true, function TimerCleaningStaff)
    set tim=null
    set gr=null
endfunction

//===========================================================================
function InitTrig_Cleaning_staff takes nothing returns nothing
    set gg_trg_Cleaning_staff=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Cleaning_staff, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    call TriggerAddCondition(gg_trg_Cleaning_staff, Condition(function Trig_Cleaning_staff_Conditions))
    call TriggerAddAction(gg_trg_Cleaning_staff, function Trig_Cleaning_staff_Actions)
endfunction
...
//TESH.scrollpos=-1
//TESH.alwaysfold=0
function Trig_Darck_heart_Conditions takes nothing returns boolean
    local integer id= GetItemTypeId(GetManipulatedItem())
    return id == 'I02E' or id == 'I03F' or id == 'I002'
endfunction

function Trig_Darck_heart_Actions takes nothing returns nothing
    local unit caster= GetTriggerUnit()
    local integer id= GetItemTypeId(GetManipulatedItem())
    ...
    if id == 'I02E' then
        set mh=100.00
        set eff=AddSpecialEffectTarget("Abilities\\Spells\\Items\\AIre\\AIreTarget.mdl", caster, "origin")
    elseif id == 'I002' then
        set mh=150.00
        set eff=AddSpecialEffectTarget("Abilities\\Spells\\Items\\AIre\\AIreTarget.mdl", caster, "origin")
    elseif id == 'I03F' then
        set mh=GetUnitState(caster, UNIT_STATE_MAX_LIFE) * 0.10
        set eff=AddSpecialEffectTarget("Objects\\Spawnmodels\\Orc\\Orcblood\\BattrollBlood.mdl", caster, "overhead")
    endif
    if id == 'I03F' then
        if life > GetUnitState(caster, UNIT_STATE_MAX_LIFE) * 0.15 then
            call SetUnitState(caster, UNIT_STATE_LIFE, life - mh)
        else
            set mh=0.00
        endif
    endif
    call SetUnitState(caster, UNIT_STATE_MANA, mana + mh)
    set caster=null
    call DestroyEffect(eff)
    set eff=null
endfunction
...
//===========================================================================
function InitTrig_Darck_heart takes nothing returns nothing
    set gg_trg_Darck_heart=CreateTrigger()
    call TriggerRegisterAnyUnitEventBJ(gg_trg_Darck_heart, EVENT_PLAYER_UNIT_USE_ITEM)
    call TriggerAddCondition(gg_trg_Darck_heart, Condition(function Trig_Darck_heart_Conditions))
    call TriggerAddAction(gg_trg_Darck_heart, function Trig_Darck_heart_Actions)
endfunction
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_Math()
    call InitTrig_Unit()
    call InitTrig_Cursed_Talisman_to_Pendant_of_Energy()
    call InitTrig_Cursed_Armor__to_Defender_Spaulders()
    call InitTrig_Cursed_Bow__to_Hunting_Bow()
...
call ExecuteFunc("jasshelper__initstructs5193406")
...
function jasshelper__initstructs5193406 takes nothing returns nothing
